 ...
 * @Title:  AccountRechargeReq.java   
 * @Package cn.trawe.pay.finance.dto.req   
 * @Description:    TODO(用一句话描述该文件做什么)   
 * @author: jianjun.chai     
 * @date:   2019年11月18日 上午11:15:04   
 * @version V1.0 
 ...
 * 注意：本内容仅限于北京特微智能科技有限公司内部传阅，禁止外泄以及用于其他的商业目 
 */
@ApiModel(value="账户充值请求类")
@Data
public class AccountRechargeReq  extends BaseReq {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5821906734990611053L;
	...
	@ApiModelProperty(value="支付类型 微信支付 WX 支付宝 ALI")
	@NotBlank(message = "支付类型 微信支付 WX 支付宝 ALI不能为空")
